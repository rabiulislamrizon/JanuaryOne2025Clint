...
const EditFAQTextTwo = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/faq-two/${id}`)
            .then((res) => res.json())
    ...
    const handleFAQText = (event) => {
        ...
        const faqTextTwo = event.target.faqTextTwo.value;
        const faqHeadingTwo = event.target.faqHeadingTwo.value;
        ...
        const url = `http://localhost:5000/update-faq-two/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                            ...
                                            <div className="contact-field p-relative c-name ">
                                                <input
                                                 hidden
                                                    ...
                                                    name="faqTextTwo"
                                                    defaultValue={faqtext.faqTextTwo}
                                        ...
                                        <div className="col-lg-12">
                                            <div className="contact-field p-relative c-name ">
                                                <input
                                                    className="form-control form-control-lg shadow-lg p-3 mb-3 bg-white rounded"
                                                    name="faqHeadingTwo"
                                                    defaultValue={faqtext.faqHeadingTwo}
