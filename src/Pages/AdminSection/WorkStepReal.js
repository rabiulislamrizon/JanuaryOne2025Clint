                                    ...
                                    <div className="col-lg-4 col-md-6 mb-4" key={work._id}>
                                        <div className="card h-100 text-center">
                                            <div className="card-body">
                                                <h5 className="card-title">{work.stepNumberReal}: {work.stepTitle}</h5>
                                                <p className="card-text">{work.stepDetailsReal}</p>
                                            </div>
                                            <div className="card-footer">
                                                <Link to={`/edit-work-real/${work._id}`} className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white">Edit Now</Link>
                                            </div>
                                        </div>
                                    </div>
                                ))
