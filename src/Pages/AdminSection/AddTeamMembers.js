                                ...
                                <form class="contact-form " onSubmit={handleMembersItemSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white" data-delay=".8s"> Add Member Item</button>
                                        </div>
                                    </div>
                                ...
                                <div className="row slider-shadow th-carousel teamSlide1" id="teamSlide1" data-slide-show={4} data-lg-slide-show={3} data-md-slide-show={2} data-sm-slide-show={2} data-xs-slide-show={1} data-arrows="true">
                                    {
                                        teamitems.map(m => <div className="col-sm-6 col-lg-4 col-xxl-3">
                                            <div className="th-team team-box wow fadeInUp">
                                                ...
                                                <Link to={`/edit-team-items/${m._id}`}><h3 className="box-title " class="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white mb-3">Edit Now</h3></Link>
