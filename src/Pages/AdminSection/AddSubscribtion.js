                        ...
                        <div className="col-lg-8 col-md-12">
                            ...
                            <form className="contact-form" onSubmit={handleSubscribtion}>
                                <div className="row">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="contact-field p-relative c-name">
                                            <input className="form-control form-control-lg mb-3" name="subscriptionStart" placeholder="Subscription Start" required />
                                        </div>
                                    </div>
                                    <div className="col-lg-12">
                                        <div className="contact-field p-relative c-name">
                                    ...
                                    <div className="slider-btn">
                                        <button className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white" data-animation="fadeInRight" data-delay=".8s">Add Subscription</button>
                                    </div>
                                </div>
                            </form>
                        </div>
