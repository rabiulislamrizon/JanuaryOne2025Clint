...
const EditProject = () => {
    ...
    const handleProject = (event) => {
        ...
        const url = `http://localhost:5000/upadete-project/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
    ...
    return (
        <>
            <HeaderBottom />
            <div>
                <section id="services" className="services-area pt-120 pb-90 fix mb-5 mt-5 vh-100">
                                ...
                                <form className="contact-form" onSubmit={handleProject}>
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12 text-center">
                                            <button className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white" data-animation="fadeInRight" data-delay=".8s">Update Project</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
