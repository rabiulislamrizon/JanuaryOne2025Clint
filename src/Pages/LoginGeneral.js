          ...
          <div className="row d-flex justify-content-center align-items-center h-100">
            <div className="col-12 col-md-8 col-lg-6 col-xl-5">
              <div
                 ...
                 style={{
                   borderRadius: "1rem",
                   background: "linear-gradient(to right, #6B58D9, #FC466B)", // Add your gradient here
                 }}
                ...
                <div className="card-body p-5 text-center">
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="mb-md-5 mt-md-4 pb-5">
                      ...
                      <label htmlFor="inp-2">
                        {errors.email && (
                          <div className="text-info">{errors.email.message}</div>
                        )}
                      </label>
                      ...
                      {signInError && <div className="text-info mb-2">{signInError}</div>}
                  ...
                  <div>
                    <p className="mb-0 text-white">
                      ...
                      <Link to="/register-general" className="text-white fw-bold">
                        Sign Up
                      </Link>
                    </p>
                  </div>
