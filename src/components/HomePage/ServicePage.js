                        ...
                        <div className="container">
                            <div className="row align-items-center justify-content-between">
                                ...
                                <div className="col-auto">
                                    ...
                                    <a href={a.buttonLink} className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white bordered-white">{a.buttonText} <i className="far fa-long-arrow-right" /></a>
                                </div>
                            </div>
                        </div>
