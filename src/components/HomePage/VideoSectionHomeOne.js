...
const VideoSectionHomeOne = () => {

  const [stepwork, setWork] = useState([]);
  const [video, setVideo] = useState([]);

  useEffect(() => {
    fetch(`http://localhost:5000/videos-one`)
      .then((res) => res.json())
              ...
              <div className="global-container">
                <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 lg:gap-20 xl:grid-cols-[minmax(0,_1fr)_.8fr] xl:gap-28 xxl:gap-[134px]">
                  <div className="jos">
                    ...
                    <a href={a.videoButtonURLOne} className="button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[18px] text-white after:bg-colorOrangyRed hover:text-white">
                      {a.videoButtonTextOne}
...
export default VideoSectionHomeOne;