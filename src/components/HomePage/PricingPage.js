                                ...
                                pricing.map(b => b.packageName === 'Basic' && <div className="col-lg-4 pb-70">
                                    <div className="pricing-item-single">
                                        ...
                                        <div className="pricing-item-list ">
                                            ...
                                            <Link to={`/order-now/${b._id}`} className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white">{b.packageButtonText} <i className="envy envy-right-arrow" /></Link>
                                    ...
                                    <div className="col-lg-4 pb-70">
                                        <div className="pricing-item-single">
                                            ...
                                            <div className="pricing-item-list">
                                                ...
                                                <Link to={`/order-now/${s._id}`} className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white">{s.packageButtonText} <i className="envy envy-right-arrow" /></Link>
                                ...
                                pricing.map(p => p.packageName === 'Standard' && <div className="col-lg-4 pb-70">
                                    <div className="pricing-item-single">
                                        ...
                                        <div className="pricing-item-list">
                                            ...
                                            <Link to={`/order-now/${p._id}`} className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white">{p.packageButtonText} <i className="envy envy-right-arrow" /></Link>
