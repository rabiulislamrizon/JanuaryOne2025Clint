                ...
                <form onSubmit={handleMessage}>
                  <div className="row">
                    ...
                    <div className="form-btn col-12">
                      <button className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white fw-btn">Appointment Now</button>
                    </div>
                  </div>
                </form>
              </div>
