...
import './ChatBoard.css'; // Optional: For styling
      ...
      <section id="services" className="services-area vh-100">
        <div className="container">
          <div className="row">
            <div>
              <div className="container">
                <Link to="/create-ticket" className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white mb-3">
                  Create Ticket
                </Link>
              </div>
                  ...
                  <tbody>
                    {currentTickets.map((t, index) => (
                      <tr key={t._id}>
                        ...
                        <td>
                          <Link className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white btn-sm" to={`/message-now/${t._id}`}>
                            Message Now
                          </Link>
                        </td>
                      </tr>
