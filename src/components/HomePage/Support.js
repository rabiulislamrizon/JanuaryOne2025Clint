            ...
            <div className="contact-from">
              ...
              <form action="#" onSubmit={handleMessage}>
                <div className="row">
                  ...
                  <div className="col-12">
                    <button className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white w-100">Send Message</button>
                  </div>
                </div>
              </form>
            </div>
...

              {
                action.map(a => <div className="col-lg-7 col-md-10">
                  <div className="cta-content">
                    ...
                    <a href={a.buttonLink} className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[8px] text-white after:bg-colorOrangyRed hover:text-white">{a.buttonText}<i className="far fa-long-arrow-right" /></a>
                  </div>
                </div>)
              }
