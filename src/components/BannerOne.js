              ...
              <div className="global-container mb-5 mt-5">
                <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-[minmax(0,_1fr)_0.7fr]">
                  ...
                  <div>
                    ...
                    <a href={b.buttonURLOne} className="jos button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorViolet py-[18px] text-white after:bg-colorOrangyRed hover:text-white">
                    {b.buttonTextOne}
                  ...
                  {/* Hero Image */}
                  <div className="">
                    <img src={b.imageOneOne} alt="hero-img-2" width={1296} height={640} className="h-auto w-full" />
                  </div>
                  {/* Hero Image */}
                </div>
              </div>
